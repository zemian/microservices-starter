    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="jhipsterApp.location.home.createOrEditLabel" v-text="$t('jhipsterApp.location.home.createOrEditLabel')">Create or edit a Location</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('jhipsterApp.location.streetAddress')" for="location-streetAddress">Street Address</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('jhipsterApp.location.postalCode')" for="location-postalCode">Postal Code</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('jhipsterApp.location.city')" for="location-city">City</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('jhipsterApp.location.stateProvince')" for="location-stateProvince">State Province</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('jhipsterApp.location.country')" for="location-country">Country</label>
